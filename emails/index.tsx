    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>
          Thanks for joining the waitlist! We get that debugging on-call incidents suck and we want to make that process as easy and streamlined as possible. 
        </Text>
        <Text style={paragraph}>
          ...
          <a href="mailto:ankil@defyci.com" style={link}>
            this email {""}
          </a>
          — I'm here to listen!
        </Text>
        <Text style={paragraph}>
          ...
          <a href="https://x.com/debugging_sucks" style={link}>
            @debugging_sucks
          </a>
        </Text>
        <Text style={signOff}>
          Best regards,
          <br />
          The Debugging Sucks Team
        </Text>
        <Hr style={hr} />
        <Text style={footer}>
          You received this email because you signed up for the Debugging Sucks waitlist.
