  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        <Img
          src={`https://reloops.app/waitlist-logo.png`}
          width="220"
          height="100"
          alt="Reloops Waitlist Logo"
          style={logo}
        />
        <Text style={greeting}>Hi {userFirstname},</Text>
        <Text style={paragraph}>
          Thanks for joining the waitlist for Reloops App! I'm Dheeraj, the developer behind this project. I'm glad to
          have you on board.
        </Text>
        <Text style={paragraph}>
          ...
          <a href="mailto:dheeraj@reloops.app" style={link}>
            this email {""}
          </a>
          — I'm here to listen!
        </Text>
        <Text style={paragraph}>
          ...
          <a href="https://x.com/dheerajbhatia2" style={link}>
            @dheerajbhatia2
          </a>
        </Text>
        <Text style={signOff}>
        ...
        <Hr style={hr} />
        <Text style={footer}>
          You received this email because you signed up for the Reloops.app waitlist.
